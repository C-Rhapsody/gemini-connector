...
### Build
Compile the source code in the `src` folder and output the executable to the `bin` folder.
...
### Run
Simply run the compiled executable as a standalone background process.
